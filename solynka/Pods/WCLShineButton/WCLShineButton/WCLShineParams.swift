...
public struct WCLShineParams {
    ...
    /// shine动画时间，秒
    public var animDuration: Double         = 1.5
    /// 大Shine的颜色
    public var bigShineColor: UIColor       = UIColor(rgb: (255, 102, 102))
    /// 是否需要Flash效果
    public var enableFlashing: Bool         = false
    /// shine的个数
    public var shineCount: Int              = 13
    /// shine的扩散的旋转角度
    public var shineTurnAngle: Float        = 0
    /// shine的扩散的范围的倍数
    public var shineDistanceMultiple: Float = 1.3
    /// 小shine与大shine之前的角度差异
    public var smallShineOffsetAngle: Float = 10
    /// 小shine的颜色
    public var smallShineColor: UIColor     = UIColor.lightGray
    /// shine的大小
    public var shineSize: CGFloat = 20
    /// 随机的颜色列表
